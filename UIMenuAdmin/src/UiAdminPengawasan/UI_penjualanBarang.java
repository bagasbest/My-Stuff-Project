 ...
 * @author User
 */
public class UI_penjualanBarang extends javax.swing.JFrame {
    String stok;
    ...
    private void maximizerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_maximizerMouseClicked
        ...
        if (maximized){
            ...
            //fullscreen - taskbar
            UI_penjualanBarang.this.setExtendedState(JFrame.MAXIMIZED_BOTH);
            GraphicsEnvironment env = GraphicsEnvironment.getLocalGraphicsEnvironment();
            UI_penjualanBarang.this.setMaximizedBounds(env.getMaximumWindowBounds());
            maximized = false;
        }
        else{
